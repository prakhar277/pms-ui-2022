      ...
      <div className="card-body">
        ...
        <div className="d-flex align-items-center justify-content-between mb-3">
          ...
          <div className="text-right d-flex">
            <button type="button" className="btn btn-primary"><i class="fa-regular fa-pen-to-square"></i></button>
            <button type="button" className="btn btn-danger ml-2"><i class="fa-solid fa-trash"></i></button>
          </div>
        </div>
